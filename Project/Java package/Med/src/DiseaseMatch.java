...
public class DiseaseMatch {
	...
	public static void main(String[] args) throws Exception {
		...
		BufferedReader brr = new BufferedReader(new FileReader(
				"C:/Users/Kartheek/Desktop/review-1/pendrive/DisList.txt"));
		String dis = "";
		...
		while ((dis = brr.readLine()) != null) {
			...
			"C:/Users/Kartheek/Desktop/review-1/pendrive/InputFile.txt"));
           while ((text = br.readLine()) != null) {
				...
				while (matcher.find()) {
					...
					String newLine = text.substring(0, start[i]) + "<DIS>"
							+ text.substring(start[i], end[i]) + "</DIS>"
		...
		System.out.println(System.currentTimeMillis());
		System.out.println("The time taken to compare a single abstract\t"+(y-x)+"milliseconds");
	}
}
